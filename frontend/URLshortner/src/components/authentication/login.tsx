      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Don’t have an account? <a href="/register" className="text-blue-600 font-medium hover:underline">Create a new account now</a>, it’s FREE! Takes less than a minute.
          </p>
